...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Centro_Medico`.`paciente` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Centro_Medico`.`medico` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Centro_Medico`.`citas` (
  ...
  INDEX `fk_citas_paciente_idx` (`paciente_No_cedula` ASC) VISIBLE,
  INDEX `fk_citas_medico1_idx` (`medico_documento` ASC) VISIBLE,
  CONSTRAINT `fk_citas_paciente`
    FOREIGN KEY (`paciente_No_cedula`)
    REFERENCES `Centro_Medico`.`paciente` (`No_cedula`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_citas_medico1`
    FOREIGN KEY (`medico_documento`)
    REFERENCES `Centro_Medico`.`medico` (`documento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Centro_Medico`.`cancelar_cita` (
  ...
  INDEX `fk_cancelar_cita_citas1_idx` (`citas_consecutivo_citas` ASC, `citas_cedula_paciente` ASC, `citas_id_medico` ASC) VISIBLE,
  CONSTRAINT `fk_cancelar_cita_citas1`
    FOREIGN KEY (`citas_consecutivo_citas` , `citas_cedula_paciente` , `citas_id_medico`)
    REFERENCES `Centro_Medico`.`citas` (`consecutivo_citas` , `cedula_paciente` , `id_medico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Centro_Medico`.`consultorio` (
  ...
  INDEX `fk_consultorio_medico1_idx` (`medico_documento` ASC) VISIBLE,
  INDEX `fk_consultorio_citas1_idx` (`citas_consecutivo_citas` ASC, `citas_cedula_paciente` ASC, `citas_id_medico` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Centro_Medico`.`tratamientos` (
  `id_tratamientod` INT NOT NULL,
  ...
  `duracion` DATETIME(24) NOT NULL,
  `paciente_No_cedula` INT NOT NULL,
  `medico_documento` INT NOT NULL,
  PRIMARY KEY (`id_tratamientod`),
  INDEX `fk_tratamientos_paciente1_idx` (`paciente_No_cedula` ASC) VISIBLE,
  INDEX `fk_tratamientos_medico1_idx` (`medico_documento` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Centro_Medico`.`medicamento` (
  ...
  `consernvacion` VARCHAR(50) NOT NULL,
  `medico_documento` INT NOT NULL,
  `tratamientos_id_tratamientod` INT NOT NULL,
  PRIMARY KEY (`codigo_nacional`),
  INDEX `fk_medicamento_medico1_idx` (`medico_documento` ASC) VISIBLE,
  INDEX `fk_medicamento_tratamientos1_idx` (`tratamientos_id_tratamientod` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_medicamento_tratamientos1`
    FOREIGN KEY (`tratamientos_id_tratamientod`)
    REFERENCES `Centro_Medico`.`tratamientos` (`id_tratamientod`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
