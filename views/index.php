          ...
          <div class="row">
            ...
            <div class="col-md-6 right d-flex justify-content-center align-items-center">
                <div class="boxContent pt-5 pb-5">
                        ...
                        <div class="form-check">
                          ...
                          <div class="form-check"> 
                            <label class="form-check-label" >
                              <a href="../views/lostpass.php">Olvido la contraseña</a>
                            </label>
                          </div>
                    ...
                    <div class="row p-4">
                        <div class="col">
                            <a href="../views/register.php" class="btn btn-line-wt">Crear cuenta</a>
                        </div>
                        <div class="col">
                            <a href="./dashboard.php"  class="btn">Ingresar</a>
                        </div>
                    </div>
