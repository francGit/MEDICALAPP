            ...
            <ul>
                ...
                <li>
                    <div class="userBox">
                        ...
                        <p data-bs-toggle="collapse" data-bs-target="#desplegar">ADMIN</p>
                        <div class="collapse multi-collapse" id="desplegar">
                            <div class="card card-body">
                               <ul>
                                <li><a class="btn btn-outline-success"><i class="fa-solid fa-address-card"></i> Perfil</a></li>
                                <li><a href="http://localhost:8888/medicalapp/view/client/" class="btn btn-outline-danger"><i class="fa-solid fa-right-from-bracket"></i> Salir</a></li>
                               </ul>
                            </div>
                            </div>
                        </div>
