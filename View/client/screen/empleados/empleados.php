...
<?php include "../../inc/head.php" ?>
    <title>Medical App | Empleados</title> 
</head>
<body>
                ...
                <div class="bodyBox"> 
                    <section class="p-5">
                        <div class="row">
                            ...
                            <div class="col-md-5 d-flex justify-content-end gap-3">  <div class="btn btn-outline-success" id="btnRegistroCita">Registrar empleado</div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
              <div class="col-md-9 d-flex justify-content-between flex-wrap gap-1">
                ...
                <div class="mb-1 w50"> 
                  <input type="text" class="form-control" id="area" placeholder="Área laboral">
                </div>
                <div class="mb-1 w50"> 
                  <input type="text" class="form-control" id="contrato" placeholder="Tipo contrato">
                </div>
                <div class="mb-1"> 
              ...
              <div class="col-md-3">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROr2Au8HaT9d1ZTK8JOY8wi561RuUzfRuz-g&usqp=CAU" class="img-fluid rounded-start" alt="...">
        ...
        <div class="modal-footer d-flex justify-content-center">
          ...
          <button type="button" id="registrarCita" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Registrar empleado</button>
        </div>
      </div>
    </div>
  </div>
